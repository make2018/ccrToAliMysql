    ...
    class oracleHelp
    {
        ...
        public oracleHelp()
        {
           ...
           //connStr = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=" + Form1.IP + ")(PORT = 1521))(CONNECT_DATA =(SERVICE_NAME =" + Form1.DB + ")));Persist Security Info=True;User ID=" + Form1.User + ";Password= " + Form1.PWD;
              ...
              connStr = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.228.141.253)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=ORCL)));Persist Security Info=True;User ID=JSL;Password=fawccr;";
        ...
        public void proc(string proc1)
        {
            try
            {
                OpenConn();
                OracleCommand commd = new OracleCommand(proc1, Connection);
